...
public class NewMealFoodDiaryListSelectionFragment extends ListFragment implements OnQueryTextListener, OnCloseListener {
    ...
    private final List<String> foodsNotSelectable = new ArrayList<>();
    ...
    private OnNewMealFoodAddition mCallback;

    // Container Activity must implement this interface
    public interface OnNewMealFoodAddition {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (OnNewMealFoodAddition) activity;
        } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString()
                    + " must implement OnNewMealFoodAddition");
        }
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        log("NewMealFoodDiaryListSelectionFragment.onCreate");
        ...
        List<FoodDiary> foodDiaries = GluCalcSQLiteHelper.getGluCalcSQLiteHelper(getActivity().getApplicationContext()).loadFoodDiaries(getMealDiaryId());
        for (FoodDiary foodDiary : foodDiaries) {
            foodsNotSelectable.add(foodDiary.getFoodName());
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        log("NewMealFoodDiaryListSelectionFragment.onCreateOptionsMenu");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        log("NewMealFoodDiaryListSelectionFragment.onCreateView");
        return inflater.inflate(R.layout.list_alphabet, container, false);
    }

    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        log("NewMealFoodDiaryListSelectionFragment.onActivityCreated");
        super.onCreate(savedInstanceState);
        initList(false, null);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        log("NewMealFoodDiaryListSelectionFragment.onOptionsItemSelected");
        switch (item.getItemId()) {
            case R.id.save:
                addAction();
                mCallback.openNewMealSecondStepFragment(getMealDiaryId());
                return true;
            default:
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        log("NewMealFoodDiaryListSelectionFragment.onListItemClick");
    ...
    public void onDetach() {
        log("NewMealFoodDiaryListSelectionFragment.onDetach");
        super.onDetach();
    }

    @Override
    public void onDestroy() {
        log("NewMealFoodDiaryListSelectionFragment.onDestroy");
        super.onDestroy();
    }

    @Override
    public void onPause() {
        log("NewMealFoodDiaryListSelectionFragment.onPause");
        super.onPause();
    }

    @Override
    public void onResume() {
        log("NewMealFoodDiaryListSelectionFragment.onResume");
        super.onResume();
    }

    @Override
    public void onStart() {
        log("NewMealFoodDiaryListSelectionFragment.onStart");
        super.onStart();
    }

    @Override
    public void onStop() {
        log("NewMealFoodDiaryListSelectionFragment.onStop");
        super.onStart();
    }

    private void displayListItem() {

        log("NewMealFoodDiaryListSelectionFragment.displayListItem");
    ...
    private List<Food> populateFoods(boolean filtered, String nameCriteria) {
        ...
        for (String foodName : foodsNotSelectable) {
            Food foodToRemove = GluCalcSQLiteHelper.getGluCalcSQLiteHelper(getActivity().getApplicationContext()).loadFoodByName(foodName);
    ...
    private void updateList() {
        ...
        log("NewMealFoodDiaryListSelectionFragment.updateList");
    ...
    public boolean onQueryTextSubmit(String query) {
        log("NewMealFoodDiaryListSelectionFragment.onQueryTextSubmit");
    ...
    public boolean onQueryTextChange(String newText) {
        log("NewMealFoodDiaryListSelectionFragment.onQueryTextChange");
    ...
    private void addAction() {
        ...
        for (final Object currentObject : rows) {
            if (currentObject instanceof Food) {
                final Food currentFood = (Food) currentObject;
                if (currentFood.isSelected()) {
                    FoodDiary newFoodDiary = new FoodDiary();
                    newFoodDiary.setMealDiaryId(getMealDiaryId());
                    newFoodDiary.setFoodName(currentFood.getName());
                    newFoodDiary.setUnit(currentFood.getUnit());
                    GluCalcSQLiteHelper.getGluCalcSQLiteHelper(getActivity().getApplicationContext()).storeFoodDiary(newFoodDiary);
                }
            }
        }
    }
